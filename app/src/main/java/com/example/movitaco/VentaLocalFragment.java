...
public class VentaLocalFragment extends Fragment {
    ...
    EditText cantidadAlimento, cantidadBebida;
    TextView ventaTotal;
    ...
    private void cargarWebService() {
        ...
        //192.168.137.127
        //192.168.1.73
        String url4 = "http://192.168.0.107/apisMesero/insertVenta.php?idMesa=" + idSMesa +
                "&idProducto=" + idSAlimento + "&catidadProducto=" + cAlimento;
